...
static void constructors(void)
{
	...
	ft::pair<int, int> a[] = {ft::pair<int, int>(0, 1), ft::pair<int, int>(1, 0), ft::pair<int, int>(2, 1)};
	std::pair<int, int> b[] = {std::pair<int, int>(0, 1), std::pair<int, int>(1, 0), std::pair<int, int>(2, 1)};
	ft::map<int, int> m1;
	std::map<int, int> m2;
...
static void insert(void)
{
	...
	std::map<int, int> m2(b, b + 3);
	m1.insert(++m1.begin(), ft::pair<int, int>(5, 5));
	m2.insert(++m2.begin(), std::make_pair(5, 5));
	check("m1 == m2", m1 == m2);
	m1.insert(ft::pair<int, int>(5, 0));
	m2.insert(std::make_pair(5, 0));
	m1.insert(ft::pair<int, int>(10, 54));
